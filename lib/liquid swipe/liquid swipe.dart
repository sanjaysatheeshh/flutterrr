...
void main() {
  runApp(MaterialApp(home: WithBuilder(),debugShowCheckedModeBanner: false,));
}
...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "assets/images/1.png", "Hi", "all", "Welcome"),
    ItemData(Colors.deepPurpleAccent, "assets/images/1.png", "Take a", "Look At",
        "Liquid Swipe"),
    ItemData(Colors.green, "assets/images/1.png", "Liked?", "Fork!", "Give Star!"),
    ItemData(Colors.yellow, "assets/images/1.png", "Can be", "Used for",
        "Onboarding design"),
    ItemData(
        Colors.pink, "assets/images/1.png", "Example", "of a page", "with Gesture"),
    ItemData(Colors.red, "assets/images/1.png", "Do", "try it", "Thank you"),
  ];
